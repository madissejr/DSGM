...
public class VeiculoController implements Serializable {
    ...
    @EJB
    private view.VeiculoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("VeiculoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("VeiculoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("VeiculoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class VeiculoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Veiculo) {
                ...
                return getStringKey(o.getIdveiculo());
            } else {
